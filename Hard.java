...
public class Hard extends Application {
    ...
    private static final int NUM_COLS = 8; //800
    private static final int NUM_ROWS = 6; //600
...
//        Image image = new Image("tiger.png");
...
// Create a group to hold the BorderPane and add it to the scene
        ...
        Scene scene = new Scene(group, 800, Const.SCREEN_HEIGHT);
